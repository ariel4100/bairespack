<div class="fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-0" style="box-shadow: unset;">
        @php($datos = \App\Content::seccionTipo('logos','texto')->first())
        <div class="container" style="background-color: #333333">
            <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset($datos->text{'header'}) }}" alt="" class="img-fluid"></a>
            ...
            <div class="collapse navbar-collapse flex-md-column" id="navbarNav">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link  ml-2 {{ request()->is('accesorios') ? 'activo' : '' }}" href="{{ route('contacto') }}"></a></li>
